/**
 * Demo build: Haus of Brunch (Detroit) for Darrin (set by Zack), Aug 19 1:00 PM ET.
...
const CONFIGS: DemoCfg[] = [
  {
    key: 'haus-of-brunch',
    businessName: 'Haus of Brunch',
    displayName: 'Haus of Brunch (Detroit) Demo',
    greeting: 'Thanks for calling Haus of Brunch, how can I help?',
    identity: `Haus of Brunch is downtown Detroit's premier brunch spot, inside the iconic Westin Book Cadillac building on Michigan Avenue. Elevated, fully halal brunch: made-from-scratch Southern and globally inspired dishes, specialty coffee, and curated mocktails. No alcohol is served, and the mocktail program is a point of pride. You answer the phone so the team can stay on the floor with guests.`,
    hoursSpoken: 'Every day, seven in the morning to four in the afternoon.',
    hoursKb: 'Daily 7am-4pm.',
    reservationsLine: 'We do reservations through OpenTable. Want me to text you the link so you can grab a table?',
    extras: [
      'Fully HALAL kitchen and NO alcohol served; the curated mocktails and specialty coffee are the pride of the drink menu. Say this warmly and confidently if anyone asks about drinks or dietary needs.',
      'Haus of Brunch is inside the Westin Book Cadillac building. For hotel matters, point the caller to the hotel front desk; you only handle the restaurant.',
      'Weekends are the rush; suggest a reservation for Saturday and Sunday visits.',
    ],
    address: '204 Michigan Ave, Detroit, MI 48226',
    addressSpoken: 'two oh four Michigan Avenue, downtown Detroit, in the Book Cadillac building',
    city: 'Detroit', state: 'MI',
    website: 'https://www.thehausofbrunch.com/',
    phoneDisplay: '(313) 262-6962',
    directLineSpoken: 'three one three, two six two, six nine six two',
    otLink: 'https://www.opentable.com/r/haus-of-brunch-detroit',
    menuLink: 'https://thehausofbrunch.com/menu',
    ownerEmail: 'logancyrus@gmail.com', ownerFirst: 'Michael', ownerLast: 'Campbell', ownerName: 'Michael Campbell',
    prospectPhone: '(313) 262-6962', // restaurant line; no mobile given
    demoAt: '2026-08-19T13:00:00-04:00',
    demoNote: 'Demo set by Zack for Wed Aug 19, 1:00 PM ET. Haus of Brunch, Westin Book Cadillac, downtown Detroit (halal brunch, no alcohol). Contact Michael Campbell as given; email logancyrus@gmail.com (name/email mismatch as provided - verify with Zack). No mobile given. Reservations via OpenTable. Demo build script.',
    areaCodes: [313, 248, 586, 734],
    nickname: 'Haus of Brunch demo',
    menu: `FULL MENU - Haus of Brunch (signature dishes; exact prices vary, so describe dishes confidently but say "prices are on the menu I can text you" if pressed for exact numbers; brunch mains generally run from the high teens into the low thirties)
FRENCH TOAST: Signature Overnight French Toast. Salted Caramel French Toast (a guest favorite). Classic French Toast.
BENEDICTS: Crab Cake Benedict. Crabby Eggs Benedict (a guest favorite).
OMELETS & CLASSICS: Seafood Omelette. Taste of Auburn Omelet. Classic Breakfast. Steak & Eggs in a Basket. The Cadillac Skillet (the namesake dish). The Southerner. Avocado Toast.
SOUTHERN & SIGNATURES: Haus Chicken N' Waffle. Etouffee Shrimp & Grits. Haus Fried Chicken Sandwich. Haus Smash Burger. Grilled Halloumi & Apple Salad.
DESSERT-ISH: Maple Pecan Bread Pudding.
DRINKS: specialty coffee program and curated MOCKTAILS (fully halal, no alcohol served).
DIETARY: fully halal kitchen; gluten-free, kosher-style, and vegan options available; tell the team about any serious allergy.`
  },
]

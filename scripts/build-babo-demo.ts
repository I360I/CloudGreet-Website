/**
 * Demo build: Babo Detroit for Darrin (set by Zack), Aug 21 3:00 PM ET. Owner: Kris Lelcaj.
...
const CONFIGS: DemoCfg[] = [
  {
    key: 'babo-detroit',
    businessName: 'Babo',
    displayName: 'Babo Detroit Demo',
    greeting: 'Thanks for calling Babo, how can I help?',
    identity: `Babo is a beloved daytime cafe and brunch spot at 15 East Kirby Street in Midtown Detroit, steps from the Detroit Institute of Arts. Babo means "dad" in Albanian; owner Kris Lelcaj named it in tribute to his father. Exceptional coffee, creative brunch and lunch with global flavor twists, full cocktails including a great espresso martini and mimosas, and pastries from Zingerman's Bakehouse. You answer the phone so the team can stay on the floor with guests.`,
    hoursSpoken: 'Tuesday through Sunday, nine in the morning to five in the afternoon. Closed Monday.',
    hoursKb: 'Tue-Sun 9am-5pm. Closed Monday.',
    reservationsLine: 'We do reservations through OpenTable. Want me to text you the link so you can grab a table?',
    extras: [
      'Babo means "dad" in Albanian; it honors owner Kris Lelcaj\'s late father. Share the story warmly if anyone asks about the name.',
      'Full bar despite being a daytime cafe: mimosas, espresso martinis, bloody marys. Weekend brunch is the rush; suggest a reservation.',
      'Pastries come from Zingerman\'s Bakehouse. Coffee drinks can be flavored (lavender, rose, caramel and more) with almond or oat milk.',
    ],
    address: '15 E Kirby St #115, Detroit, MI 48202',
    addressSpoken: 'fifteen East Kirby Street in Midtown Detroit, right by the D I A',
    city: 'Detroit', state: 'MI',
    website: 'https://www.babodetroit.com/',
    phoneDisplay: '(313) 974-6159',
    directLineSpoken: 'three one three, nine seven four, six one five nine',
    otLink: 'https://www.opentable.com/r/babo-detroit',
    menuLink: 'https://www.babodetroit.com/menu',
    ownerEmail: 'kris@babodetroit.com', ownerFirst: 'Kris', ownerLast: 'Lelcaj', ownerName: 'Kris Lelcaj',
    prospectPhone: '(313) 974-6159',
    demoAt: '2026-08-21T15:00:00-04:00',
    demoNote: 'Demo set by Zack for Fri Aug 21, 3:00 PM ET. Babo, Midtown Detroit. Kris Lelcaj is the OWNER (closeable buyer). kris@babodetroit.com. NOTE: the given "mobile" 313-974-6159 is the RESTAURANT main line, not a personal cell. Reservations via OpenTable. Demo build script.',
    areaCodes: [313, 248, 586, 734],
    nickname: 'Babo Detroit demo',
    menu: `FULL MENU - Babo Detroit (real prices, say them casually)
BREAKFAST/BRUNCH: Avo Toast 10. Breakfast Tacos 18 (chorizo, eggs, guacamole). Eggs Benedict 19. Kimchi Patatas Bravas 18 (a signature: garlic potatoes, kimchi, gochujang, two eggs). Frida Skillet 15 (sweet potatoes, kale, goat cheese). Diego Skillet 18 (chorizo, cheddar, guacamole). Granola Bowl 11. Chorizo Omelette 18. Wild Mushroom & Truffle Omelette 19. Caprese Omelette 17. Lemon Ricotta Pancakes 18 (a guest favorite). Creme Brulee French Toast 18 (caramelized challah). Countryman Breakfast 18. Breakfast Smash 18. Huevos Rancheros 14. Chicken & Waffles 19 (bourbon-cayenne honey). Waffle & Berries 14.
SHAREABLES: Truffle Fries 10. Krispy Wings 19 (gochujang). Elote Dip 14.
SALADS: Harvest 16. Caesar 13. Cobb 17. Garden 8. Add protein 6 to 9.
BURGERS & SANDWICHES: Babo Burger 21 (double patty, bacon, fried egg, fries - THE signature). Build Your Own Burger 15-16 (beef or Beyond). Buffalo Chicken Sandwich 14. Zay's Jerk Chicken Tacos 16. Korean Beef Cheesesteak 19 (bulgogi ribeye, kimchi). Caprese Baguette 14. Tuna Melt 14.
SIDES 4-5: toast, english muffin, bagel and cream cheese, two eggs, sausage, bacon, fruit, home fries, shoestring or sweet potato fries, tomato bisque.
DESSERTS: Chocolate Truffle Cake 9 (flourless). Churros 11. Fresh Zingerman's pastries.
DRINKS: house coffee 3, espresso 4, latte or cappuccino 5 (flavors +1: caramel, vanilla, lavender, rose, raspberry, blueberry, mocha, cinnamon-honey, hazelnut, matcha; almond or oat milk +1). Chai latte 5. Hot cocoa 5. Fresh lemonade 3, lavender lemonade 6, OJ 5.
COCKTAILS: Mimosa 10 (or 40 for the carafe). Espresso Martini 14. Bloody Mary 15. Aperol Spritz 15. Helenita 16 (tequila, guava). Cucumber G+T 16. Mojito 13. La Violeta 12 (lavender). French 75 16. Sidecar 14. Beers 4-5 (Bell's Two Hearted, Oberon, Modelo). Wine 8-65.
KIDS: scrambled eggs + fruit 9, french toast sticks 12, cheeseburger + fries 11, hamburger + fries 9, waffle 9, oatmeal 6.
DIETARY: Beyond burger available; tell the team about any serious allergy.`
  },
]

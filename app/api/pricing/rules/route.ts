...
export async function GET(request: NextRequest) {
  try {
    ...
    if (error) {
      logger.error('Error fetching pricing rules', error, { businessId, serviceType })
    ...
    logger.error('Pricing rules API error', error as Error, { 
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (error) {
      logger.error('Error creating pricing rule', error, { businessId, ruleData: validatedData })
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (error) {
      logger.error('Error updating pricing rule', error, { ruleId: id, updateData: validatedData })
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (error) {
      logger.error('Error deleting pricing rule', error, { ruleId: id })

...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (callsError) {
      logger.error('Error fetching call analytics', callsError, {
        requestId,
        businessId,
        userId
      })
    ...
    if (appointmentsError) {
      logger.error('Error fetching appointment analytics', appointmentsError, {
        requestId,
        businessId,
        userId
      })
    ...
    if (smsError) {
      logger.error('Error fetching SMS analytics', smsError, {
        requestId,
        businessId,
        userId
      })
    ...
    logger.error('AI agent analytics error', error as Error, {
      requestId,

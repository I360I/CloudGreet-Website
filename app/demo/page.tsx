...
export default function Home() {
  ...
  const handleRoiChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setRoiData(prev => ({ ...prev, [name]: parseInt(value) || 0 }))
  }

  const calculateROI = () => {
    const { jobValue, closeRate, bookingsPerMonth } = roiData
    
    // Calculate monthly revenue: bookings * job value * close rate
    ...
    const roi = Math.round((netProfit / cloudGreetFee) * 100)
              ...
              <div className="grid gap-6 md:grid-cols-3 mb-8">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-700" 
                    placeholder="2500"
                  />
                </div>
                <div>
                ...
                <form onSubmit={handleLeadSubmit} className="space-y-4">
                  <div>
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-700"
                    />
                  </div>
                  <div>
                    <input

  ...
  return (
    <>
      ...
      <motion.nav 
        ...
        className="border-b border-purple-500/20 backdrop-blur-xl bg-black/30 sticky top-0 z-50"
        role="navigation"
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/landing" className="flex items-center hover:opacity-80 transition-opacity cursor-pointer relative z-10">
              ...
              >
                <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-blue-300">CloudGreet</span>
              </motion.div>
            </Link>
            <div className="hidden md:flex items-center space-x-8">
              <motion.a 
                whileHover={{ y: -2 }}
                href="#how-it-works" 
                className="text-gray-300 hover:text-purple-300 transition-colors duration-300 font-medium relative group"
              >
                How it Works
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="/login"
              className="bg-white/10 backdrop-blur-xl text-white px-8 py-3 rounded-xl font-semibold border border-white/20 hover:bg-white/15 hover:border-purple-400/50 transition-all duration-300 shadow-lg hover:shadow-purple-500/25"
            >
              Sign In
            </motion.a>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-purple-300">Revenue Calculator</span>
            </motion.div>
            
            <h2 className="text-6xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-purple-200 to-blue-300">
              Calculate Your ROI
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              See how much revenue you could recover from missed calls with our AI receptionist
            </p>
          </motion.div>
          ...
          <motion.div 
            ...
            className="relative"
          >
            {/* Glow effect around calculator */}
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-3xl blur-2xl"></div>
            <div className="relative bg-gray-800/20 backdrop-blur-xl rounded-3xl border border-purple-500/20 p-8">
              <RoiCalculator />
            </div>
          </motion.div>
        </div>
      ...
      <section id="how-it-works" className="py-24 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }} />
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-purple-300">AI-Powered Process</span>
            </motion.div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Three simple steps to transform your business communication with AI
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            ...
            >
              ...
              <div className="relative bg-gray-800/30 backdrop-blur-xl p-10 rounded-3xl border border-purple-500/20 text-center shadow-2xl group-hover:border-purple-400/40 transition-all duration-500">
                <div className="relative mb-8">
                  <div className="w-20 h-20 bg-gradient-to-r from-purple-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto text-4xl font-bold shadow-lg group-hover:shadow-purple-500/25 transition-all duration-500">
                    1
                  </div>
            ...
            >
              ...
              <div className="relative bg-gray-800/40 backdrop-blur-xl p-10 rounded-3xl border border-gray-700/50 text-center shadow-2xl group-hover:border-purple-500/30 transition-all duration-500">
                <div className="relative mb-8">
                  <div className="w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto text-4xl font-bold shadow-lg group-hover:shadow-purple-500/25 transition-all duration-500">
                    2
                  </div>
            ...
            <motion.div 
              ...
              className="group relative"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-pink-500/20 to-red-500/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-500" />
              <div className="relative bg-gray-800/40 backdrop-blur-xl p-10 rounded-3xl border border-gray-700/50 text-center shadow-2xl group-hover:border-pink-500/30 transition-all duration-500">
                <div className="relative mb-8">
                  <div className="w-20 h-20 bg-gradient-to-r from-pink-500 to-red-500 rounded-2xl flex items-center justify-center mx-auto text-4xl font-bold shadow-lg group-hover:shadow-pink-500/25 transition-all duration-500">
                    3
                  </div>
                ...
                <h3 className="text-3xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-red-400">
                  Books Appointments
                </h3>
                <p className="text-gray-300 text-lg leading-relaxed">
                ...
                <div className="mt-6 flex justify-center">
                  <div className="w-12 h-1 bg-gradient-to-r from-pink-500 to-red-500 rounded-full" />
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-900/50 via-black/50 to-gray-900/50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <h2 className="text-6xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-200 to-purple-300">
      ...
      <section id="pricing" className="py-24 bg-gradient-to-br from-gray-900/50 via-black/50 to-gray-900/50 relative overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-3xl blur-2xl group-hover:blur-3xl transition-all duration-500" />
              
              {/* Card */}
              <div className="relative bg-gray-800/20 backdrop-blur-2xl p-12 rounded-3xl border border-purple-500/20 shadow-2xl group-hover:border-purple-400/40 transition-all duration-500">
                {/* Only Plan Badge */}
                ...
                {/* Plan Title */}
                <h3 className="text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-400">
                  Complete Solution
                </h3>
                ...
                <div className="mb-8">
                  ...
                  <div className="flex items-baseline justify-center gap-2 mb-4">
                    ...
                    <span className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-emerald-400">
                      $50
                    </span>
                    <span className="text-lg text-gray-300">per booking</span>
                  </div>
                </div>
                ...
                <Link
                  href="/start"
                  className="group w-full bg-white/10 backdrop-blur-xl text-white px-12 py-5 rounded-2xl text-xl font-semibold border border-white/20 hover:bg-white/15 hover:border-purple-400/50 transition-all duration-300 shadow-2xl hover:shadow-purple-500/25 inline-block"
                >
      ...
      <section className="py-24 bg-gradient-to-r from-purple-600/10 via-blue-600/15 to-purple-600/10 border-y border-purple-500/20 relative overflow-hidden">
        {/* Electric Background Elements */}
        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/5 via-transparent to-blue-500/5" />
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2.5s' }} />
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
          ...
          <motion.p 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="text-2xl text-gray-200 mb-16 max-w-4xl mx-auto leading-relaxed"
          >
            Join service businesses who never miss another opportunity. 
            <span className="text-purple-400 font-semibold"> Start growing today.</span>
          </motion.p>
          ...
          >
            <Link
              href="/start"
              className="group bg-white/10 backdrop-blur-xl text-white px-12 py-6 rounded-2xl text-2xl font-semibold border border-white/20 hover:bg-white/15 hover:border-purple-400/50 transition-all duration-300 shadow-2xl hover:shadow-purple-500/25 flex items-center justify-center gap-4 inline-block"
            >
          ...
          <div className="relative mt-16">
            {/* Animated Background Lines - Temporarily disabled */}
      ...
      {/* Premium Footer */}
      <footer className="bg-gradient-to-br from-gray-900/80 via-black/80 to-gray-900/80 py-16 border-t border-purple-500/20 relative overflow-hidden">
        {/* Electric Background Elements */}
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center mb-6">
                <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-purple-200">CloudGreet</span>
              </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <a href={`tel:${process.env.NEXT_PUBLIC_SUPPORT_PHONE || '+1-800-CLOUDGREET'}`} className="block text-gray-400 hover:text-white transition-colors duration-300">Call: {process.env.NEXT_PUBLIC_SUPPORT_PHONE || '+1-800-CLOUDGREET'}</a>

            ...
            >
              ...
              <div className="relative bg-gray-800/40 backdrop-blur-xl p-10 rounded-3xl border border-gray-700/50 text-center shadow-2xl group-hover:border-blue-500/30 transition-all duration-500">
                <div className="relative mb-8">
                  <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center mx-auto text-4xl font-bold shadow-lg group-hover:shadow-blue-500/25 transition-all duration-500">
                    1
                  </div>
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gray-800/30 backdrop-blur-2xl p-12 rounded-3xl border border-gray-700/50 shadow-2xl group-hover:border-blue-500/30 transition-all duration-500">
                ...
                {/* Plan Title */}
                <h3 className="text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">
                  Complete Solution
                </h3>
                ...
                <div className="mb-8">
                  <div className="flex items-baseline justify-center gap-2 mb-2">
                    <span className="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">
                      $200
                    </span>

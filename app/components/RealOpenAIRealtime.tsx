...
interface RealOpenAIRealtimeProps {
  businessName?: string
  businessType?: string
  services?: string
  hours?: string
...
export default function RealOpenAIRealtime({
  ...
  // Connect to OpenAI Realtime API using WebRTC approach
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 min-h-screen bg-black">
      {/* Real OpenAI Realtime Voice Orb */}
      <div className="relative mb-8">
        <motion.button
          onClick={isConnected ? (isListening ? stopListening : startListening) : connect}
          className="relative w-96 h-96 rounded-full overflow-hidden focus:outline-none focus:ring-4 focus:ring-purple-300/50 transition-all duration-500"

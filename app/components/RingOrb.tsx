...
const RingOrb: React.FC<RingOrbProps> = ({ 
 ...
 <div className="w-20 h-20 rounded-full bg-sky-500/10 backdrop-blur-sm border-2 border-sky-400/30 flex items-center justify-center hover:bg-sky-500/20 hover:border-sky-400/50 transition-all duration-300 pointer-events-auto shadow-lg shadow-sky-500/20">
 <Phone className="w-10 h-10 text-sky-300 drop-shadow-[0_0_8px_rgba(192,132,252,0.8)]" />
 </div>
 </div>
 )}
 </div>

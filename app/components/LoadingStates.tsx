...
export function LoadingCard({ title, description, icon, progress }: LoadingCardProps) {
 ...
 className="bg-black/30 backdrop-blur-xl rounded-2xl p-8 border border-sky-500/20"
 >
...
export function LoadingOverlay({ message, submessage }: LoadingOverlayProps) {
 ...
 >
 <div className="bg-black/30 backdrop-blur-xl rounded-2xl p-8 border border-sky-500/20 max-w-md w-full mx-4">

  ...
  <section className="relative min-h-[100dvh] overflow-hidden bg-[#f6f5f1] px-5 sm:px-8">
   ...
   <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center pt-4 text-center sm:pt-8 md:pt-10">
    <h1 className="font-display font-medium tracking-tighter leading-[0.92] text-gray-900 text-[clamp(2.25rem,7vw,6rem)]">
     Stop losing{' '}
     <span className="bg-gradient-to-b from-sky-300/60 via-blue-400/50 to-blue-600/55 bg-clip-text text-transparent drop-shadow-[0_3px_18px_rgba(56,189,248,0.55)]">
      profit
     </span>
     <br />
     to voicemail.
  ...
  <>
   <div className="flex flex-col sm:flex-row gap-3">
    ...
    <button
     ...
     className="group inline-flex items-center justify-center gap-2.5 whitespace-nowrap rounded-2xl border border-white/60 bg-blue-500/20 px-7 py-4 text-base font-medium text-white [text-shadow:0_1px_3px_rgba(15,23,42,0.45)] backdrop-blur-2xl backdrop-saturate-150 shadow-[0_18px_44px_-16px_rgba(37,99,235,0.4),inset_0_1px_0_0_rgba(255,255,255,0.9),inset_0_-10px_24px_-14px_rgba(255,255,255,0.55)] transition-all hover:-translate-y-0.5 hover:bg-blue-500/30"
    >
     Test our AI

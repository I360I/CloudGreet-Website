...
import {
 MdOutlinePhone, MdOutlineArrowOutward, MdOutlineArrowForward, MdOutlineCalendarToday, MdOutlineAccessTime, MdOutlineAttachMoney, MdOutlineStar,
 MdOutlinePhoneCallback, MdOutlineChatBubbleOutline, MdOutlineDescription, MdOutlinePhoneForwarded, MdOutlineCheckCircle,
 MdOutlinePlace, MdOutlineVerifiedUser,
} from "react-icons/md"
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
     ...
     >
      ...
      <span className="w-7 h-7 rounded-full border border-gray-300 flex items-center justify-center group-hover:border-gray-900 transition-colors">
       <MdOutlineArrowForward className="w-3.5 h-3.5" strokeWidth={2.5} />
      </span>
     </a>
     <Link
      href="/contact"
     ...
     >
      Book Demo
      <MdOutlineArrowOutward className="w-5 h-5" strokeWidth={2} />
     </Link>
    </div>
...
function Stats() {
 const items = [
  { icon: MdOutlineAccessTime, value: '5+ hrs/week', label: 'saved on the phone' },
  { icon: MdOutlineAttachMoney, value: '$2,500/mo', label: 'recovered from missed calls' },
  { icon: MdOutlineCalendarToday, value: '24/7', label: 'coverage, never miss a call' },
  { icon: MdOutlineStar, value: '+1.2 stars', label: 'in average review ratings' },
 ]
 return (
  <section className="px-6 pb-32 md:pb-40">
...
function CallFlow() {
 const steps = [
  { icon: MdOutlinePhoneCallback, title: 'Incoming call.', body: 'Customer dials your main number — no new lines needed.' },
  { icon: MdOutlinePhone, title: 'AI agent answers.', body: 'Picks up instantly or after a set number of rings.' },
  { icon: MdOutlineChatBubbleOutline, title: 'Call is handled.', body: 'AI talks naturally, answers questions, and books appointments.' },
  { icon: MdOutlineDescription, title: 'Summary sent.', body: 'Name, number, and reason for calling sent to you by SMS.' },
  { icon: MdOutlinePhoneForwarded, title: 'Ends or transfers.', body: 'Resolved calls end. Others are passed to your team.' },
 ]
 return (
    ...
    <div className="relative bg-white border border-gray-200 rounded-2xl p-5 md:p-6">
     <div className="flex items-center justify-between mb-4">
      <h3 className="text-base font-semibold flex items-center gap-2">
       <MdOutlinePhone className="w-4 h-4 text-sky-500" /> Recent Calls
      </h3>
    ...
    <div className="grid md:grid-cols-4 gap-8">
     <div>
      ...
      <p className="text-sm text-gray-500 flex items-center gap-1.5">
       <MdOutlinePlace className="w-3.5 h-3.5" /> Built in Austin, TX
      </p>
     </div>
     <div>
     ...
     <div>
      ...
      <ul className="space-y-2 text-sm text-gray-600">
       ...
       <li className="flex items-center gap-1.5"><MdOutlineVerifiedUser className="w-3.5 h-3.5" /> 30-day money-back</li>
      </ul>
     </div>
    </div>

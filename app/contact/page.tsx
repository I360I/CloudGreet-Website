...
import { MdOutlinePhone, MdOutlineMail, MdOutlinePlace, MdOutlineCheck } from "react-icons/md"
     ...
     <div className="relative md:col-span-2 space-y-4">
      ...
      <div className="bg-white border border-gray-200 rounded-[28px] p-6 md:p-8">
       ...
       <ul className="space-y-3 text-sm text-gray-700">
        <li className="flex items-start gap-2.5"><MdOutlineCheck className="w-4 h-4 text-sky-500 mt-0.5 flex-shrink-0" />A demo of the AI handling a sample call for your business</li>
        <li className="flex items-start gap-2.5"><MdOutlineCheck className="w-4 h-4 text-sky-500 mt-0.5 flex-shrink-0" />Setup walkthrough &mdash; we wire it up for you, no DIY</li>
        <li className="flex items-start gap-2.5"><MdOutlineCheck className="w-4 h-4 text-sky-500 mt-0.5 flex-shrink-0" />Pricing, plan options, and a clear ROI for your numbers</li>
       </ul>
      </div>

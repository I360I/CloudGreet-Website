...
/**
 * Sales portal theme store (CRM Pro branch).
 *
 ...
 * - Applied as `data-sales-theme` on <html> so fixed/portaled surfaces
...
function apply(t: DashTheme) {
  try { document.documentElement.setAttribute('data-sales-theme', t) } catch {}
}
...
export function setSalesTheme(t: DashTheme) {
  current = t

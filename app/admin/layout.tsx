...
export default function AdminLayout({
 ...
 w-64 bg-black border-r-2 border-sky-500/30
 ...
 {/* Header */}
 <div className="p-6 border-b-2 border-sky-500/30 relative z-10">
 <div className="flex items-center justify-between mb-4">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 border-2 border-sky-500 flex items-center justify-center bg-black">
 <Shield className="w-6 h-6 text-sky-500" />
 </div>
 <div>
 <h1 className="text-white font-mono font-bold text-sm tracking-wider">ADMIN</h1>
 <p className="text-sky-400 font-mono text-xs">DASHBOARD</p>
 </div>
 </div>
 <button
 onClick={() => setSidebarOpen(false)}
 className="lg:hidden text-sky-400 hover:text-sky-300 transition-colors"
 ...
 {/* Main Section */}
 <div>
 <h2 className="text-sky-500/50 font-mono text-xs uppercase tracking-wider mb-3 px-2">
 MAIN
 </h2>
 ...
 : 'bg-black border-sky-500/10 text-gray-400 hover:bg-sky-500/5 hover:border-sky-500/30 hover:text-sky-400'
 }
 `}
 >
 ...
 {/* Footer */}
 <div className="p-4 border-t-2 border-sky-500/30 relative z-10">
 <button
 ...
 {/* Mobile Header */}
 <header className="lg:hidden bg-black border-b-2 border-sky-500/30 p-4 flex items-center justify-between sticky top-0 z-30">
 <button

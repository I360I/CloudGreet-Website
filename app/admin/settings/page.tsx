...
export default function OwnerSettingsPage() {
 ...
 <article className="rounded-xl border border-white/10 from-white/5 via-white/0 to-white/10 p-4 md:p-6 shadow-2xl shadow-blue-900/10">
 ...
 <section className="rounded-xl border border-white/10 from-white/5 via-white/0 to-white/10 p-4 md:p-6 shadow-2xl shadow-blue-900/20">
 <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
 <div>
 ...
 className="group relative flex h-full flex-col justify-between rounded-xl border border-white/10 from-white/5 via-white/0 to-white/10 p-4 md:p-6 shadow-2xl shadow-blue-900/10 transition hover:-translate-y-1 hover:border-white/20 hover:shadow-blue-900/30"
 >

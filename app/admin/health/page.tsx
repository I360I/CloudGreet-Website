...
export default function AdminHealthPage() {
 ...
 className="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 rounded"
 >
 {runningTests ? (
 <>
